...
$grid = new C_DataGrid("select
							transactionId
							, campaignName
							, SUBSTRING_INDEX(postbackTimestamp,' ',-2) as TimeStamp
							, Year
							, Month
							, Day
						from
							duplicateLog
						", "transactionId", "conversion");
...
$grid -> set_col_width("transactionId", 100);
$grid -> set_col_width("campaignName", 300);
$grid -> set_col_width("TimeStamp", 70);
