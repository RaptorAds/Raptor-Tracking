...
<head>
	<meta charset="utf-8">
	<title>RaptorAds Report (Summary by Offer)</title>
...
$grid -> set_col_width("offerName", 420);
...
$('#conversion').jqGrid('footerData', 'set', {'offerName':'Total' ,'Cost':totalCost.toFixed(2) ,'Revenue': totalRev.toFixed(2) ,'Profit': totalProfit.toFixed(2), 'Total': colSum });
}
LOADCOMPLETE;
...
<div id="wrapper">
  <div id="leftWrapper">
      <div id="listView" class="list">
        ...
        <li class="list-item-active"><a href="https://admin.raptorads.com/grid_sum.php">Summary by Offer</a></li>
        <li><a href="https://admin.raptorads.com/grid_sumCampaign.php">Summary by Campaign</a></li>
