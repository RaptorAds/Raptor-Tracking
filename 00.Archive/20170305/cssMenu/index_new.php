...
function searchGrid(){
  ...
  <div id="leftWrapper">
      <div id="listView" class="list">
		...
		<li><a href="#" onclick="window.open('https://admin.raptorads.com/grid_countdupe.php','_blank');" >Count Duplicate</a></li>
        <li><a href="#" onclick="window.open('https://admin.raptorads.com/grid_sum.php','_blank');" >Summary by Offer</a></li>
        <li><a href="#" onclick="window.open('https://admin.raptorads.com/grid_sumCampaign.php','_blank');" >Summary by Campaign</a></li>
        <li><a href="#" onclick="window.location.href='https://admin.raptorads.com/login/logout.php';" >Logout</a></li>
      </div>
    </div>
    <div id="rightWrapper">
